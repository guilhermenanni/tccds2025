...
<body>
    <div class="container">
        <!-- Sidebar Esquerda (adaptada para usuário) -->
        <div class="left-sidebar">
            ...
            <nav class="nav-menu">
                <ul>
                    <li><a href="home_us.php"><span class="icon-home"></span>Home</a></li>
                    <li><a href="#" class="active"><span class="icon-profile"></span>Perfil</a></li>
                    <li><a href="home_us.php" onclick="mostrarAba('seletivas-disponiveis')"><span class="icon-seletivas"></span>Seletivas Disponíveis</a></li>
                    <li><a href="home_us.php" onclick="mostrarAba('postagens-curtidas')"><span class="icon-liked"></span>Postagens Curtidas</a></li>
                </ul>
            </nav>

            <!-- Perfil do Usuário Logado (se estiver logado como usuário) -->
            <?php if ($usuario_logado && $tipo_usuario_logado === 'usuario'): ?>
            <?php
            $id_usuario_logado = $_SESSION['id'];
            $sql_usuario_logado = "SELECT img_usuario, nm_usuario, email_usuario FROM tb_usuario WHERE id_usuario = $id_usuario_logado";
            $res_usuario_logado = $conex->query($sql_usuario_logado);
            $dados_usuario_logado = $res_usuario_logado->fetch_assoc();
            $imagem_usuario_logado = !empty($dados_usuario_logado['img_usuario']) && file_exists('uploads/' . $dados_usuario_logado['img_usuario']) ? $dados_usuario_logado['img_usuario'] : 'default.png';
            ?>
            <div class="profile-card">
                <img src="uploads/<?php echo htmlspecialchars($imagem_usuario_logado); ?>" alt="Imagem do usuário">
                <h3><?php echo htmlspecialchars($dados_usuario_logado['nm_usuario']); ?></h3>
                <p><?php echo htmlspecialchars($dados_usuario_logado['email_usuario']); ?></p>
        ...
        <div class="main-content">
            <a href="home_us.php" class="voltar-btn">← Voltar para Home</a>
            ...
            <div id="postagens" class="aba-conteudo ativa">
                ...
                if ($result_posts->num_rows > 0) {
                    while ($post = $result_posts->fetch_assoc()) {
                        ...
                        // Formulário para adicionar comentário (apenas se usuário logado)
                        if ($usuario_logado && $tipo_usuario_logado === 'usuario') {
    ...
    <script>
        ...
        function curtirPostagem(idPostagem, elemento) {
            ...
            var url = 'curtir_postagem_usuario.php'; // para usuário
